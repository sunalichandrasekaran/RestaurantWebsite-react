        ...
        <div className="container">
          ...
          <div className="text-center mb-20 max-w-[400px] mx-auto">
            ...
            <p className="text-xs text-gray-400">
              ...
              nescium explicabo a! Laborem delectus aliquam labore,earum rerum
              quam!Nulla?
            </p>
          </div>
          {/* {card section} */}
                ...
                return (
                  <>
                    <div
                      ...
                      className="max-w-[300px] group rounded-2xl bg-white dark:bg-gray-800 dark:hover:bg-primary hover:bg-primary hover:text-white duration-300 p-4 shadow-xl"
                    >
